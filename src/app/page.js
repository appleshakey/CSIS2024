...
export default function Home() {
  ...
  const timer = useParallax({
    speed: 30,
  })

  const tickets = useParallax({
    speed: 20,
  })
  ...
  const splticket = useParallax({
    speed: 30,
  })

  const event_partners = useParallax({
    speed: 20,
  })

  const event_sponsors = useParallax({
    speed: 20,
  })
  
  const why_csis = useParallax({
    speed: 20,
  })
  ...
  return (
    <div className=" h-[700vh] flex flex-col gap-28 px-[82px]">
      <div>
      ...
      <div className="bg-black">
        <div className=" text-white bg-black py-9 px-12 flex flex-col gap-16" ref={info.ref}>
        ...
        <div className="bg-black h-[50vh] text-white font-staat p-5 flex flex-col gap-3" ref={timer.ref}>
        ...
        <div className="bg-black text-white font-staat p-5 flex flex-col gap-5" ref={tickets.ref}>
        ...
        <div className="flex flex-col text-white font-staat items-center gap-7" ref={splticket.ref}>
      ...
      <div className="text-white font-staat flex flex-col items-center gap-8" ref={event_partners.ref}>
        <div className="text-3xl">
      ...
      <div className="flex flex-col items-center gap-7" ref={event_sponsors.ref}>
      ...
      <div className="flex flex-col items-center text-white font-staat gap-7" ref={why_csis.ref}>
        <div className="text-3xl">
          <h1>Why CSIS?</h1>
        </div>
