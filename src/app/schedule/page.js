    ...
    <div className="flex justify-center">
      <div className="text-white font-staat py-32 px-6 flex flex-col gap-44 -z-50 ">
        ...
        <div className="flex flex-col mt-10">
            ...
            <div>
              <div className="flex gap-2">
                ...
                <div className="flex justify-between lg:flex-row sm:flex-row w-[65vw] bg-[#fffef3] border-r-4 border-[#ea580b] rounded-md p-3">
                  ...
                  <div className="flex text-sm items-center text-[#000002] p-3 font-semibold">
                    July 29, 2024 10:00 to 11:00 AM
                  </div>
                </div>
              </div>
          ...
          <div className="h-[15vh] flex flex-col relative font-style mt-4 md:mt-6 lg:mt-4 xl:mt-0">
            <div className="w-[4vh] flex justify-center">
            ...
            <div>
              <div className="flex gap-2">
                ...
                <div className="flex justify-between lg:flex-row sm:flex-row w-[65vw] bg-[#fffef3] border-r-4 border-[#ea580b] rounded-md p-3">
                  ...
                  <div className="flex text-xs sm:text-[14px] items-center font-semibold text-[#000002] p-3">
                    July 29, 2024 12:00 to 01:00 PM
                  </div>
                </div>
              </div>
            ...
            <div>
              <div className="flex gap-2">
                ...
                <div className="flex justify-between lg:flex-row sm:flex-row w-[65vw] bg-[#fffef3] border-r-4 border-[#ea580b] rounded-md p-3">
                  ...
                  <div className="flex text-xs sm:text-[14px] items-center text-[#000002] p-3 font-semibold">
                    July 29, 2024 02:00 to 03:00 PM
                  </div>
                </div>
              </div>
            ...
            <div>
              <div className="flex gap-2">
                ...
                <div className="flex justify-between lg:flex-row sm:flex-row w-[65vw] bg-[#fffef3] border-r-4 border-[#ea580b]  rounded-md p-3">
                  ...
                  <div className="flex text-sm items-center text-[#000002] font-semibold p-3">
                    July 29, 2024 04:00 to 04:20 PM
                  </div>
                </div>
              </div>
          ...
          <div className="h-[10vh] flex flex-col relative top-5 font-style mt-4 md:mt-4 lg:mt-4 xl:mt-0">
            ...
            <div>
              <div className="flex gap-2">
                ...
                <div className="flex flex-col sm:flex-row border-r-4 justify-between w-[65vw] bg-[#ea580b] rounded-md p-3">
                  <div className="flex flex-col justify-center">
                    <div className="text-sm sm:text-[24px] font-semibold">
          ...
          <div className="h-[16vh] flex flex-col relative top-5 font-style mt-4 md:mt-4 lg:mt-4 xl:mt-0">
            ...
            <div>
              <div className="flex gap-2">
                ...
                <div className="flex justify-between sm:flex-row w-[65vw] bg-[#fffef3] border-r-4 border-[#ea580b]  rounded-md p-3">
                  <div className="flex flex-col justify-center">
                    <div className="text-sm sm:text-[24px] text-[#000002] font-semibold">
              ...
              <div className="flex gap-2">
                ...
                <div className="flex justify-between sm:flex-row w-[65vw] bg-[#fffef3] border-r-4 border-[#ea580b]  rounded-md p-3">
                  <div className="flex flex-col justify-center">
                    ...
                    <div className="text-sm  mt-3 sm:text-[18px] text-[#000002]">
                      <p>Venue: Auditorium</p>
                    </div>
                  </div>
                  <div className="flex  text-sm items-center text-[#000002] font-semibold p-3">
