    ...
    <div>
      {isMobileScreen ? (
        <div className="text-white font-white h-[100vh] w-[100vw] flex items-center justify-center px-[82px] gap-24 ">
          <button
            className="flex flex-col text-white font-staat gap-7 items-center"
            onClick={() => router.push("/schedule/day1")}
          >
            {/* <div className="rounded-full bg-gray-300 h-[16vh] w-[16vh]"></div> */}
            <img
                  className="rounded-full h-[16vh] w-[16vh] transform transition-transform duration-300 ease-in-out group-hover:scale-110"
                  src="/schedule/done.jpg"
          ...
          <button
            className="flex flex-col text-white font-staat gap-7 items-center"
            onClick={() => router.push("/schedule/day3")}
          >
            {/* <div className="rounded-full bg-gray-300 h-[16vh] w-[16vh]"></div> */}
            <img
                  className="rounded-full h-[16vh] w-[16vh] transform transition-transform duration-300 ease-in-out group-hover:scale-110"
          ...
          <div className="flex flex-col">
              ...
              <div>
                <div className="flex gap-2">
                  <div className="w-[4vh] flex justify-center z-10">
                    <div className="rounded-full w-[3vh] h-[3vh] bg-gradient-to-t from-[#00a6fb] to-[#00334d] absolute"></div>
                  </div>
            ...
            <div className="h-[15vh] flex flex-col relative top-6">
              ...
              <div>
                <div className="flex gap-2">
                  <div className="w-[4vh] flex justify-center">
                    <div className="rounded-full w-[3vh] h-[3vh] bg-gradient-to-t from-[#00a6fb] to-[#00334d] absolute z-10"></div>
                  </div>
                  <div className="flex justify-between w-[75vw]">
                    <div className="flex flex-col justify-center">
                      <div className="text-2xl font-semibold">
