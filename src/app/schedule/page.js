      ...
      {isMobileScreen ? (
        ...
        <div className="text-white font-staat py-32 px-6 flex flex-col gap-44 -z-50">    
              ...
              <div>
                <div className="flex gap-2">
                  ...
                  <div className="flex justify-between w-[75vw] bg-gradient-to-t from-[#1565C0] to-[#BBDEFB] p-3   rounded-md">
                    ...
                    <div className={"flex items-center text-white p-3 " + font}>
                      July 29, 2024 9:00 to 10:00 AM
                    </div>
                  </div>
                </div>
              ...
              <div>
                <div className="flex gap-2">
                  ...
                  <div className="flex justify-between w-[75vw]  bg-gradient-to-t from-[#fffef3] to-[#fffef3] rounded-md p-3">
                    <div className={"flex flex-col text-[#0D47A1] justify-center "+font}>
                      <div className="text-xl font-medium">
                        <h1>Inauguration</h1>
                      </div>
                      <div className="text-lg">
                    ...
                    <div className={"flex text-[#0D47A1] items-center p-3" + font}>
                      July 29, 2024 10:00 to 11:00 AM
                    </div>
                  </div>
                </div>
              ...
              <div>
                <div className="flex gap-2">
                  ...
                  <div className="flex justify-between w-[75vw]  bg-gradient-to-t from-[#fffef3] to-[#fffef3] rounded-md p-3">
                    ...
                    <div className={"flex text-sm text-[#0D47A1] items-center p-3"+font}>
                      July 29, 2024 02:00 to 03:00 PM
                    </div>
                  </div>
                </div>
              ...
              <div>
                <div className="flex gap-2">
                  ...
                  <div className="flex justify-between w-[75vw] bg-gradient-to-t from-[#1565C0] to-[#BBDEFB] p-3 rounded-md">
                    ...
                    <div className={"flex text-sm items-center text-white p-3 "+font}>
                      July 29, 2024 03:00 to 04:00 PM
                    </div>
                  </div>
                </div>
          ...
          <div className="flex flex-col mt-14">
              ...
              <div>
                <div className="flex gap-2">
                  ...
                  <div className="flex justify-between w-[75vw] bg-gradient-to-t from-[#1565C0] to-[#BBDEFB] p-3   rounded-md">
                    ...
                    <div className={"flex items-centertext-white p-3 "+font}>
                      July 30, 2024 2:00 to 03:30 PM
                    </div>
                  </div>
                </div>
              ...
              <div>
                <div className="flex gap-2">
                  ...
                  <div className="flex justify-between w-[75vw]  bg-gradient-to-t from-[#fffef3] to-[#fffef3] rounded-md p-3">
                    ...
                    <div className={"flex text-[#0D47A1] items-center p-3 "}>
                      July 30, 2024 03:30 to 04:30 PM
                    </div>
                  </div>
                </div>
            ...
            <div className="h-[26vh] flex flex-col relative top-7">
              <div className="w-[4vh] flex justify-center">
                <div className="border-l-2 border-white h-[26vh] -z-10"></div>
              </div>
              <div>
                <div className="flex gap-2">
                  <div className="w-[4vh] flex justify-center z-10">
