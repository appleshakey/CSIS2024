            ...
            <div className="flex flex-col items-center gap-7">
              ...
              <div className="grid grid-cols-3 gap-8 xl:gap-32">
                ...
                <SpeakerCard
                  ...
                  para="President of Students & Young Professionals at
IEEE Computer Society.Leading strategic
activities and initiatives for the world's largest
organisation related to Computer Science. ASIC
Design Engineer (SoC) at Intel Corporation, driving
best-in-class performance for Intel Xeon Memory
Controllers, aligning IP with CEO's IDM2.0
Strategy. based in Santa Clara County, California,
United States, and San Francisco Bay Area."
                  image="/image3.jpeg"               
                />
                <SpeakerCard
...
papers. As an Associate Editor of the Elsevier Journal
...
Artificial Intelligence as a service."
              ...
              <div className="grid grid-cols-2 justify-center  gap-8 xl:gap-32 ">
                <SpeakerCard
