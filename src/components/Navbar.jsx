      ...
      {isMobileScreen ? (
        <div className="text-white font-staat text-2xl px-[82px] flex justify-between py-3 items-center fixed w-full z-50 bg-black">
          ...
          <button
            ...
            className="bg-[#5cb1f6] opacity-80 px-3 py-1 text-md rounded-md"
          >
            register Now
          </button>
        </div>
        ...
        <motion.div className="flex justify-between p-3 items-center fixed w-[100vw] z-50 bg-black">
          ...
          <motion.div
            className="fixed h-[100vh] w-[100vw] left-0 top-0 flex justify-center items-center z-50 bg-gray-900 bg-opacity-50"
            animate={MNavbar ? "open" : "close"}
          ...
          >
            <motion.div className="text-white text-3xl h-[100vh] w-[100vw] bg-gradient-to-t from-iem_ticket_b to-iem_ticket_t rounded-lg p-5 flex flex-col gap-5 z-50">
              ...
              <motion.div
                className="text-4xl font-staat flex justify-center"
                variants={menuItemVariant}
              >
                <h1>Menu</h1>
              </motion.div>
              <motion.div
                className="flex flex-col items-center font-staat gap-5"
                variants={menuVariant}
              >
                <motion.button
                  onClick={() => {
